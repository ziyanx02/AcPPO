...
ENVS_ROOT_DIR = f"{EUREKA_ROOT_DIR}/envs"
...
def main(cfg):
    ...
    task_file = f'{EUREKA_ROOT_DIR}/envs/genesis/{env_name}.py'
    task_obs_file = f'{EUREKA_ROOT_DIR}/envs/genesis/{env_name}_obs.py'
    shutil.copy(task_obs_file, f"env_init_obs.py")
    task_code_string  = file_to_string(task_file)
    task_obs_code_string  = file_to_string(task_obs_file)
    output_file = f"{ENVS_ROOT_DIR}/generated/{env_name}{suffix.lower()}.py"
    ...
    # create_task(ENVS_ROOT_DIR, cfg.env.task, cfg.env.env_name, suffix)
    ...
    for iter in range(cfg.iteration):
        ...
        for response_id in range(cfg.sample):
            ...
            with open(rl_filepath, 'w') as f:
                process = subprocess.Popen(['python', '-u', '/home/ziyanx/python/AcPPO/eureka/train.py',
                                            f'-t {env_name}',],
                                            stdout=f, stderr=f)

...
import torch
import wandb
from envs.generated.leap_handgpt import LeapHand
...
def main(args):
    ...
    # load cfgs
    log_dir = current_dir / 'logs' / args.exp_name

    print("Network Directory:", log_dir)
    print("Tensorboard Directory:", log_dir)

    with open(f'{current_dir}/cfg/task/{args.cfg}', 'r') as file:
